...
class UserInput(_keys.Keys):
    ...
    **kwargs :
    ...
    def ext_dir_keys(self, keylist):
        """Placeholder for external directory navigation keys."""
        # 如果你未来想在 GPIO 0, 1, 2, 3 上实现特定的系统导航功能，
        # 可以在这里编写逻辑。现在留空即可避免崩溃。
        pass
    ...
    def _get_new_keys(self):  # noqa: ANN202
        ...
        for key, key_time in tracker.items():
            ...
            and key not in _keys.NO_REPEAT_KEYS \
